...
export default class Command extends BaseCommand {
    ...
    run = async (M: ISimplifiedMessage): Promise<void> => {
        ...
        MessageType.image,
                    undefined,
                    undefined,
                    `_*-⚡[Rules to use the bot are below]⚡ -*_\n\n❌*DONT ASK FOR THE SCRIPT*🚫\n*>>>* use ?support to get the Official group link in your dm\n*--->* If you want to add tyler in your group the contact the owner by *?owner/?mods* \n*--->* Dont use wrong command, use the command given in the *help list* \n*--->* Dont spam the bot with commands if the bot is not responding, its means the bot maybe offline or facing internet issue. \n*--->* Dont Dm the bot \n\n*IF YOU DONT FOLLOW THE RULES THEN YOU WILL BE BANED SOON* 🚫  `,
                    undefined
                ).catch((reason: any) =>
